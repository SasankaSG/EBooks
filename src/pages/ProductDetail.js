...
import { getProductItem } from "../services";
...
export const ProductDetail = () => {
    ...
    useEffect(() => {
      ...
      //check if item in cart, change it to remove
      useEffect(() => {
    ...
    //2 dependencies : cartlist cuz we are ulitizing it & prod.id becuase we are using in find
