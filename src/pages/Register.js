...
export const Register = () => {
  ...
  async function handleRegister(event) {
      ...
      const authDetail = {
        ...
        //navigating to products page after registering else toast error display
        ...
        <section>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
                ...
                <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="abc123@example.com" required autoComplete="off" />
            </div>
            <div className="mb-6">
